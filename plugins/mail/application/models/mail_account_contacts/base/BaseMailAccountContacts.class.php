...
/**
 * BaseMailAccountContacts class
 *
 * @author Ignacio de Soto <ignacio.desoto@fengoffice.com>
 */
abstract class BaseMailAccountContacts extends DataManager {
	 ...
	 * Construct
	 *
	 * @return BaseMailAccountContacts
	 */
	function __construct() {
		Hook::fire('object_definition', 'MailAccountContact', self::$columns);
		parent::__construct('MailAccountContact', 'mail_account_contacts', true);
	} // __construct
	...
	function find($arguments = null) {
		if(isset($this) && instance_of($this, 'MailAccountContacts')) {
			...
			return MailAccountContacts::instance()->find($arguments);
	...
	function findAll($arguments = null) {
		if(isset($this) && instance_of($this, 'MailAccountContacts')) {
			...
			return MailAccountContacts::instance()->findAll($arguments);
			//$instance =& MailAccounts::instance();
	...
	function findOne($arguments = null) {
		if(isset($this) && instance_of($this, 'MailAccountContacts')) {
			...
			return MailAccountContacts::instance()->findOne($arguments);
			//$instance =& MailAccounts::instance();
	...
	function findById($id, $force_reload = false) {
		if(isset($this) && instance_of($this, 'MailAccountContacts')) {
			...
			return MailAccountContacts::instance()->findById($id, $force_reload);
			//$instance =& MailAccounts::instance();
	...
	function count($condition = null) {
		if(isset($this) && instance_of($this, 'MailAccountContacts')) {
			...
			return MailAccountContacts::instance()->count($condition);
			//$instance =& MailAccounts::instance();
	...
	function delete($condition = null) {
		if(isset($this) && instance_of($this, 'MailAccountContacts')) {
			...
			return MailAccountContacts::instance()->delete($condition);
			//$instance =& MailAccounts::instance();
